...
#define câmbio switch 
#define caso case 
#define acaso default
...
#define elems_tipo(prefixo) \
    juntar(prefixo, tipo_nil),              /* nil */               \
    juntar(prefixo, tipo_charactére),       /* char */              \
    juntar(prefixo, tipo_linha),            /* char* ou Linha */    \
    juntar(prefixo, tipo_inteiro),          /* int */               \
    juntar(prefixo, tipo_tamanho),          /* size_t */            \
