...
struct EF_Interpretar {
	...
	void (*operação_aparar_e_re_definir)(EF_Interpretar ref ef, Grade ref intérprete, Expectação expectação, Operação_Tipo operação_tipo);
};
...
void interpretar_linha(int ref expressão_n, Grade ref linha, Grade ref intérprete);
